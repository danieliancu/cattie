...
return [
    'terms-and-conditions' => [
        ...
        'description' => 'The terms that apply when you browse Cattie.uk or place an order with us.',
        'sections' => [
            ['Using Cattie.uk', ['By using this website, you agree to use it lawfully and not interfere with its security or operation. Product information, availability and prices may be updated before an order is accepted.']],
            ...
            ['Contact', ['Questions about these terms can be sent to support@cattie.uk.']],
        ],
    ],
    'faq' => [
        'title' => 'FAQ',
        ...
        'sections' => [
            ...
            ['Where is my order?', ['Tracking details will be provided when they are available. If an expected parcel has not arrived, contact support@cattie.uk with your order number.']],
    ...
    'returns-policy' => [
        ...
        'sections' => [
            ['Personalised Products', ['Each Cattie product is made especially for you using your approved personalised artwork. Because personalised items are made to order, we cannot normally accept returns or exchanges if you simply change your mind.']],
            ['Damaged or Defective Items', ['If your item arrives damaged or defective, contact support@cattie.uk as soon as possible with your order number and a description of the issue. We may ask for clear photographs so we can assess what happened and put it right.']],
            ...
            ['How to Contact Us', ['Email support@cattie.uk with your order number, a short explanation and any requested photographs. We will review the information and explain the next steps.']],
    ...
    'privacy-policy' => [
        ...
        'description' => 'How Cattie.uk uses and protects personal information, including uploaded photographs.',
        'sections' => [
    ...
    'payment-methods' => [
        ...
        'sections' => [
            ...
            ['Currency and total', ['Cattie.uk displays prices in pounds sterling. The complete payable total, including any confirmed delivery charge, is shown before payment is authorised.']],
            ['Payment security', ['Payments are handled through the secure payment service presented at checkout. Cattie.uk does not need to store your complete card number or card security code when payment is processed by that provider.']],
            ...
            ['If payment fails', ['Check that the payment details, billing information and available funds are correct, then try again. Your bank may decline a payment without sharing the reason with us. If the problem continues, contact your provider or email support@cattie.uk with the error message, but never send full card details.']],
