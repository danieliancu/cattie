<x-layouts.storefront title="Sign in | Cattie.uk" description="Sign in to see your Cattie orders.">
<section class="shell py-12 sm:py-20"><div class="mx-auto max-w-md">
    ...
    <p class="mt-6 text-center text-sm text-muted">New to Cattie? <a class="font-bold text-coral" href="{{ route('register', array_filter(['claim_order' => $claimOrder])) }}">Create an account</a></p>
</div></section>
