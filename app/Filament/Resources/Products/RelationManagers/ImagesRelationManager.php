...
class ImagesRelationManager extends RelationManager
{
    ...
    public function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            TextInput::make('alt_text')->required(), Toggle::make('is_primary'), Toggle::make('is_active')->default(true), TextInput::make('sort_order')->numeric()->default(0),
    ...
    public function table(Table $table): Table
    {
        ...
        return $table->columns([ImageColumn::make('storage_key')->disk('public'), TextColumn::make('alt_text'), TextColumn::make('variant.name'), TextColumn::make('role')])->headerActions([CreateAction::make()->after($syncPrimary)])->recordActions([EditAction::make()->after($syncPrimary), DeleteAction::make()])->reorderable('sort_order');
    }
}
